...
var getQuote = function getQuote(query) {
  (0, _axios2.default)({
    method: "get",
    ...
    if (res.data.length === 0) {
      ...
      var episode = res.data[0].Episode;
      ...
      (0, _axios2.default)({
        ...
        console.log(res);
        res.data.Subtitles.forEach(function (subtitle) {
